<template>
  <div class="w-full flex justify-center items-center h-screen">
    <div class="w-1/4 bg-slate-100 shadow-2xl rounded-lg flex flex-col items-center p-1">
      ...
      <img class="w-1/4 rounded-full" src="https://img.freepik.com/psd-gratis/ilustracion-3d-avatar-o-perfil-humano_23-2150671116.jpg?w=740&t=st=1697923861~exp=1697924461~hmac=79c5e6592f092deb47d61899ccef1a723d309290792bb4ee652ed5d8015bde08" alt="avatar">
      <div class="mt-4 w-full">
        <form @submit.prevent="handlerLogin" class="w-full">
          <div class="w-full my-4">
            <label for="email">Correo Electronico</label>
            <input class="w-full border mt-0.5 h-8 outline-none rounded-md" type="email" placeholder="name@streaming.com" v-model="email">
          </div>
          <div class="w-full my-4">
            <label for="password">Contraseña</label>
            <input class="w-full border mt-0.5 h-8 outline-none rounded-md" type="password" placeholder="**********" v-model="password">
          </div>
