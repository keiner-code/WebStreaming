<template>
  <div class="my-10 flex flex-col items-center w-full">
    <div class="w-full pl-3">
      <div class="border md:w-1/5 rounded-lg pr-2">
        <input
    ...
    <div class="flex w-full justify-center mt-4 p-4 overflow-auto">
      <table class="table-column-group w-full">
        ...
        <tbody>
          ...
          >
            ...
            <td>{{ item.title }}</td>
            <td>{{ item.provider }}</td>
            <td class="w-1/6 hidden sm:inline-block">{{ item.description }}</td>
            <td>{{ item.duration }}</td>
            <td>{{ item.renewal }}</td>
            <td>{{ item.price }}</td>
          </tr>
